    ...
    <div className="about-section-container">
      ...
      <div className="about-section-text-container">
        <p className="primary-subheading">
          <h1>Taptengelei Ticketing</h1>
          </p>
        <h2 className="primary-heading">
         Encounter the shereheee like never before!!!
        </h2>
        <p className="primary-text">
        Taptengelei Ticketing App streamlines the event booking process, providing users with a user-friendly interface and seamless booking experience. 
